...
# graph-viz page digest (its CSS is inline); W3.5 changes JavaScript; W3.6
# changes both pages and JavaScript because it fills the config emitter.
# CSS remains byte-identical at W3.6.
#
